...
import BookingData from "./BookingInquiryData";
...
const AdminBooking = () => {
	const columns = [
		...
		{ field: "date", headerName: "BookingDate", width: 130 },
		{ field: "checkindate", headerName: "CheckinDate", width: 130 },

		{ field: "checkoutdate", headerName: "CheckoutDate", width: 130 },
	...
	const handleroutes = (e) => {
		navigation(`/EditBookingInquiry/${e.id}`, { state: e });
}
